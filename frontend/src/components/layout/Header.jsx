        ...
        <header className="header">
            <nav className="navbar">
                <Link to="/" className="logo">
                    ...
                    <img src="/assets/images/gopher.png" alt="Go Gopher" className="gopher" />
                </Link>
                ...
                <ul className="nav-menu">
                    ...
                    <li><Link to="/seller" className="nav-link">Продавцам</Link></li>
                    <li><Link to="/help" className="nav-link">Помощь</Link></li>
                </ul>
                ...
                <div className="nav-buttons">
                    ...
                    <Link to="/auth/login" className="btn-icon user-menu" aria-label="Профиль">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
